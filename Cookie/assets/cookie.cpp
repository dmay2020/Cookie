...
int main(int argc, char* argv[]) {
    ...
    std::cout << std::endl;
    std::cout << "                a88888b.                   dP       oo                       a8888a     d8888b.         " << std::endl;
    std::cout << "               d8'   `88                   88                               d8' ..8b        `88         " << std::endl;
    std::cout << "               88        .d8888b. .d8888b. 88  .dP  dP .d8888b.    dP   .dP 88 .P 88    .aaadP' .d8888b." << std::endl;
    std::cout << "               88        88'  `88 88'  `88 88888    88 88ooood8    88   d8' 88 d' 88    88'     88'  `88" << std::endl;
    std::cout << "               Y8.   .88 88.  .88 88.  .88 88  `8b. 88 88.  ...    88 .88'  Y8'' .8P dP 88.     88.  .88" << std::endl;
    std::cout << "                Y88888P' `88888P' `88888P' dP   `YP dP `88888P'    8888P'    Y8888P  88 Y88888P `88888P8" << std::endl;
    std::cout << std::endl << std::endl;

    std::cout << "Filenames:" << std::endl << std::endl;
    for (int i = 0; i < filenames.size(); i++) {
        std::cout << filenames[i] << std::endl;
    }

    std::cout << std::endl << "You may now exit. ";
